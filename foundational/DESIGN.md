...
| 2026-09-15 | Fix   | Every future day with no row now previews the schedule as a ghost row, not only the rest of the current week — otherwise the rest of the year read as a run of "Off" days that simply hadn't happened yet. Ghost rows are muted and keep the "From schedule" marker; on the punch card and strip every day after today stays hatched (a preview is a plan, not a record) and its cell label omits hours. A future day the schedule doesn't cover reads "Not yet", never "Off", and a future day's editor opens on the scheduled values.                                                                                                                                                                                                                                                                                                                                                 |
